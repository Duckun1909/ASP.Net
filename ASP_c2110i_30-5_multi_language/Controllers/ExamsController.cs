...
namespace Test2.Controllers
{
    public class ExamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExamId,StudentId,SubjectId,Mark")] Exam exam)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExamId,StudentId,SubjectId,Mark")] Exam exam)
        {
            if (id != exam.ExamId)
            {
                return NotFound();
